 ...
 * removes them.
 */
public abstract class AbstractGameObject2dController implements IGameObjectManagerListener {
     ...
     */
    public AbstractGameObject2dController(final Stage gameStageTmp) {
     ...
     */
    protected abstract Actor createGameObject2d(IGameObject gameObject);
}
